...
const Filter = ({state}) => {
    ...
    return (
        <div className="input-group" style={{marginTop: '90px'}}>
            ...
            <form autoComplete="off" className="col-md-8 px-4">
                <input type="text" className="form-control" placeholder="Enter Product Name ..." list="title_product"
